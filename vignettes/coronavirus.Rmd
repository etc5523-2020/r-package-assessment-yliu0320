...
After people install the package from github to their local rstudio,they should load the package first and then use the function "launch_app" to get the shiny app.
...
coronavirus_region%>%
  ...
  arrange(State)%>%
  kable(align="c",caption="Number of confirmed/deaths/recovered in Australia(from 2020.01.12 to 2020.10.02)") %>% 
  kable_styling()
```
